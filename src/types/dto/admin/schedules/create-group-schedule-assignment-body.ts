...
/**
 * Body del endpoint POST /admin/schedule/group-assignment.
 *
 * Asigna una plantilla de horario a un grupo durante un rango de fechas.
 *
...
export const CreateGroupScheduleAssignmentBodySchema = z
  .object({
