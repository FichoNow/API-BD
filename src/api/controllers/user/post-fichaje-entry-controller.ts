...
import {  PostFichajeEntryBody, PostFichajeEntryBodySchema } from "../../../types/dto/user/post-fichaje-entry-body.js";
import { 
    BodyResponse,
    ResponseError,
  } from "../../../types/express/response-type.js";
import { createFichajeEntryService } from "../../../services/user/create-fichaje-entry-service.js";
